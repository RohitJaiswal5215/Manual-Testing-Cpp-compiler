...
- Executed manual tests on different inputs (valid/invalid programs).  
...
##  Tools & Skills Used
- **Testing Types:** Functional Testing, Usability Testing, Negative Testing    
- **Techniques:** Equivalence Partitioning (EP), BVA 
